...
import (
	...
	"github.com/setoru/cluster-api-provider-huawei/test/utils"
)
...
var (
	...
	projectImage = "example.com/cluster-api-provider-huawei:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-api-provider-huawei integration test suite\n")
